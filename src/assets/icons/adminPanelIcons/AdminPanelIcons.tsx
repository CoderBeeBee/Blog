...
// COLLECTION: Brightspace Filled Interface Icons
// LICENSE: MIT License
// AUTHOR: BrightspaceUI
...
const SecuritySVG = ({ className }: IconsProps) => (
	<svg
		...
		/>
		<path d="M49.99 87c-6.456-4.8-17.698-14.432-24.241-27.342-6.672-13.166-9.255-28.423-10.243-37.38L50 10.129l34.494 12.149c-.987 8.95-3.569 24.21-10.243 37.379C67.741 72.505 56.448 82.184 49.99 87z" />
		<path
			fill="#ffffff"
		...
		/>
		<path opacity={0.08} d="M50 0L5 15.784s.566 27.022 11.995 49.481C28.06 87.008 50 100 50 100V0z" />
	</svg>
)
// <!-- License: MIT. Made by vmware: https://github.com/vmware/clarity-assets -->
...
const NewsletterSVG = ({ className }: IconsProps) => (
	<svg
		...
		xmlns="http://www.w3.org/2000/svg"
		xmlnsXlink="http://www.w3.org/1999/xlink"
		className={` ${styles.newsletterSVG} ${className ? className : ''}`}>
...
const AdsSVG = ({ className }: IconsProps) => (
	<svg
		fill="currentColor"
		xmlns="http://www.w3.org/2000/svg"
		viewBox="0 0 98.25 98.25"
		className={className ? className : ` ${styles.adsSVG}`}>
		<path d="M60.516,60.307c0.416-27.098-6.328-54.438-7.817-60.125C51.512,0.096,50.333,0,49.125,0C21.994,0,0,21.994,0,49.125 c0,1.35,0.096,2.682,0.203,4.001C17.857,60.96,41.229,62.021,60.516,60.307z"></path>{' '}
		<path d="M98.002,54.052c0.158-1.625,0.248-3.262,0.248-4.927c0-23.744-16.854-43.555-39.248-48.132 c1.777,6.868,7.715,31.995,7.365,58.714C81.396,57.991,93.486,55.182,98.002,54.052z"></path>{' '}
		<path d="M43.289,66.977c-14.279,0-29.123-1.771-42.008-6.852c5,21.825,24.5,38.125,47.844,38.125 c1.592,0,3.161-0.091,4.713-0.236c3.934-9.669,5.869-20.1,6.462-31.218C54.842,67.259,49.119,66.977,43.289,66.977z"></path>{' '}
		<path d="M96.93,60.271c-5.949,1.434-17.146,3.85-30.731,5.36c-0.537,10.741-2.314,21.476-5.785,31.263 C78.507,92.634,92.719,78.389,96.93,60.271z"></path>
	</svg>
)
// <!-- License: CC Attribution. Made by Mariusz Ostrowski: https://github.com/mariuszostrowski/subway -->
const WebsiteSVG = ({ className }: IconsProps) => (
	<svg
		fill="currentColor"
		height="800px"
		width="800px"
...
const DetailsSVG = ({ className }: IconsProps) => (
	<svg
		...
		viewBox="0 0 1024 1024"
		xmlns="http://www.w3.org/2000/svg"
		className={className ? className : ` ${styles.detailsSVG}`}>
		<path d="M149.333333 85.333333h725.333334v853.333334H149.333333z" fill="#065f43" />
		<path
...
const PlusSVG = ({ className }: IconsProps) => (
	<svg
		fill="currentColor"
		width="800px"
		height="800px"
		...
		xmlns="http://www.w3.org/2000/svg"
		className={className ? className : ` ${styles.plusSVG}`}>
...
const FilterSVG = ({ className }: IconsProps) => (
	<svg
		fill="currentColor"
		width="800px"
		height="800px"
...
const SaveSVG = ({ className }: IconsProps) => (
	<svg
		width="800px"
		height="800px"
		viewBox="0 0 16 16"
		xmlns="http://www.w3.org/2000/svg"
		fill="currentColor"
		className={`${styles.saveSVG} ${className ? className : ''}`}>
		<path d="M11.04 1.33L12.71 3l.29.71v.33h-.5l-.5.5v-.83l-1.67-1.67H10v4H4v-4H2v10h3l-.5 1H2l-1-1v-10l1-1h8.33l.71.29zM7 5h2V2H7v3zm6.5 0L15 6.5l-.02.69-5.5 5.5-.13.12-.37.37-.1.09-3 1.5-.67-.67 1.5-3 .09-.1.37-.37.12-.13 5.5-5.5h.71zm-6.22 7.24l-.52 1 1.04-.48-.52-.52zm.69-1.03l.79.79 5.15-5.15-.79-.79-5.15 5.15z" />
	</svg>
)
// License: MIT. Made by Ant Design: https://github.com/ant-design/ant-design-icons -->
const ClearSVG = ({ className }: IconsProps) => (
	<svg
		width="1024px"
		height="1024px"
		viewBox="0 0 1024 1024"
		...
		xmlns="http://www.w3.org/2000/svg"
		xmlnsXlink="http://www.w3.org/1999/xlink"
		className={`${styles.clearSVG} ${className ? className : ''}`}>
...
const RestoreSVG = ({ className }: IconsProps) => (
	<svg
		xmlns="http://www.w3.org/2000/svg"
		fill="currentColor"
		width="800px"
		height="800px"
		viewBox="0 0 24 24"
		className={`${styles.restoreSVG} ${className ? className : ''}`}>
...
const BackSVG = ({ className }: IconsProps) => (
	<svg
		fill="currentColor"
		width="800px"
		height="800px"
		viewBox="0 0 14 14"
		xmlns="http://www.w3.org/2000/svg"
		className={`${styles.backSVG} ${className ? className : ''}`}>
		<path
			d="M 21,11 14,4 V 8 C 7,9 4,14 3,19 5.5,15.5 9,13.9 14,13.9 V 18 l 7,-7 z"
			transform="matrix(-0.66666667,0,0,0.66666667,15,-0.66666671)"
		/>
	</svg>
)
// <!-- License: Apache. Made by bytedance: https://github.com/bytedance/IconPark -->
const TagSVG = ({ className }: IconsProps) => (
	<svg
		width="800px"
		height="800px"
		viewBox="0 0 48 48"
		fill="currentColor"
		xmlns="http://www.w3.org/2000/svg"
		className={`${styles.tagSVG} ${className ? className : ''}`}>
		<path
		...
		/>
		<path d="M16 18H32" stroke="white" strokeWidth={4} strokeLinecap="round" strokeLinejoin="round" />
	</svg>
)
// <!-- License: Apache. Made by Carbon Design: https://github.com/carbon-design-system/carbon -->
const CategorySVG = ({ className }: IconsProps) => (
	<svg
		width="32px"
		height="32px"
		fill='currentColor'
		...
		id="icon"
		xmlns="http://www.w3.org/2000/svg"
		className={`${styles.categorySVG} ${className ? className : ''}`}>
